...
use djfhe\ControllerTransformer\PHPStan\Typescript\TypescriptTypes\TsObjectPropertyType;
use djfhe\ControllerTransformer\PHPStan\Typescript\TypescriptTypes\TsObjectType;
use PHPStan\Analyser\OutOfClassScope;
use ReflectionProperty;

class LaravelDataParser implements _TsTypeParserContract
{
    ...
    protected static function parseProperty(String $name, \PHPStan\Reflection\ExtendedPropertyReflection $property, Scope $scope, ReflectionProvider $reflectionProvider): TsObjectPropertyType {
      ...
      $tsType = TsTypeParser::parse($property->getReadableType(), $scope, $reflectionProvider);
    ...
    protected static function parseLiteralTypescriptAttribute(array $attributes, Scope $scope, ReflectionProvider $reflectionProvider): ?_TsType {
      ...
      return TsTypeParser::parse($arg, $scope, $reflectionProvider);
    }
